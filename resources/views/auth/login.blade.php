...
<div class="flex h-screen items-center justify-center bg-dark-900 relative">
    ...
    <div class="rounded-xl bg-white px-16 py-10 shadow-lg backdrop-blur-md max-sm:px-8">
        <div class="text-black">
          ...
          <form action="#" class="mx-auto max-w-lg">
            <div class="mb-4 text-lg">
              <input class="rounded-3xl border-none bg-white-400 bg-opacity-50 px-6 py-2 text-center text-inherit placeholder-black shadow-lg outline-none w-full" type="text" name="name" placeholder="Email" />
            </div>

            <div class="mb-4 text-lg">
              <input class="rounded-3xl border-none bg-white-400 bg-opacity-50 px-6 py-2 text-center text-inherit placeholder-black shadow-lg outline-none w-full" type="Password" name="name" placeholder="Password" />
            </div>
